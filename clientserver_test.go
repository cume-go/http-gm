...
import (
	...
	"log"
	"net"
	. "github.com/cume-go/http-gm"
	"github.com/cume-go/http-gm/httptest"
	"github.com/cume-go/http-gm/httputil"
	"net/url"
	"os"
	"reflect"
	"runtime"
...
// transport_test.go (for HTTP/1) or x/github.com/cume-go/http-gm2/transport_test.go
// (for HTTP/2).
...
func testWriteHeaderAfterWrite(t *testing.T, h2, hijack bool) {
	...
	wantLog := "http: superfluous response.WriteHeader call from github.com/cume-go/http-gm_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	if hijack {
		wantLog = "http: response.WriteHeader on hijacked connection from github.com/cume-go/http-gm_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	}
