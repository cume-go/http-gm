...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/cume-go/http-gm.(*Client).Get":          true,
		"github.com/cume-go/http-gm.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/cume-go/http-gm.http2Server":           false,
		"github.com/cume-go/http-gm.(*Server).Serve":       false,
		"github.com/cume-go/http-gm.(*ServeMux).ServeHTTP": false,
		"github.com/cume-go/http-gm.DefaultServeMux":       false,
	}
...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", "github.com/cume-go/http-gm").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", "github.com/cume-go/http-gm").CombinedOutput()
	if err != nil {
