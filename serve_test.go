...
import (
	...
	"github.com/cume-go/http-gm/internal"
	"net/url"
	"os"
	"os/exec"
	"path/filepath"
...
// response, the github.com/cume-go/http-gm package adds a "Content-Length: 0" response
// header.
...
func TestHTTP10ConnectionHeader(t *testing.T) {
	...
	// github.com/cume-go/http-gm uses HTTP/1.1 for requests, so write requests manually
	tests := []struct {
