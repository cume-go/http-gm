...
var (
	...
	// anything in the github.com/cume-go/http-gm package. Callers should not
...
// is preferred:
//    https://golang.org/pkg/github.com/cume-go/http-gm/#ResponseWriter
//    https://golang.org/pkg/github.com/cume-go/http-gm/#example_ResponseWriter_trailers
...
// relevantCaller searches the call stack for the first function outside of github.com/cume-go/http-gm.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/cume-go/http-gm.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/cume-go/http-gm: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.isSet() {
		panic("github.com/cume-go/http-gm: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.isSet() {
		panic("github.com/cume-go/http-gm: CloseNotify called after ServeHTTP finished")
	}
...
// recognized by x/github.com/cume-go/http-gm2 to pass down a context; the TLSNextProto
